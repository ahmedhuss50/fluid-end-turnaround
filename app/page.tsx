    ...
    <>
      <div className="page-head">
        <div>
          ...
          <p>Digital work order records with dual PSI + operator sign-off.</p>
        </div>
      ...
      <div className="card">
        <div className="card-head"><h2>Recent work orders</h2></div>
        {jobs.length === 0 ? (
          <div className="empty">
            ...
            <div className="big">No work orders yet</div>
            <div>Create your first work order to get started.</div>
